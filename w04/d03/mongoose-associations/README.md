...
* update `models.js` to connect to your Mongo DB
* create a new file for each step so that the operations can be repeated
  * for example, if you name the first step `solution-01.js` you can run the script in terminal with `node solution-01.js`
